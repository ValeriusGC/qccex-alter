...
QVariantList QstAbstractModelHandler::virtuallyCheckedKeys(const FieldRole &) const
{
	return QVariantList();
}

QstVariantListMap QstAbstractModelHandler::virtuallyCheckedFields(const QStringList &,
                                                                  const QstWhere &) const
{
...
QstVariantListMap QstAbstractModelHandler::_virtuallyCheckedFields(const QStringList &,
                                                                   const QstWhere &) const
{
