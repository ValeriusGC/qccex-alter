...
// или текущей строки во view (comboBox).
    ...
    virtual QVariantList		virtuallyCheckedKeys(const FieldRole &) const;		// FIX ME
    virtual QstVariantListMap	virtuallyCheckedFields(const QStringList &, const QstWhere &) const;
...
protected:
    ...
    virtual QstVariantListMap	_virtuallyCheckedFields(const QStringList &, // FIX ME
